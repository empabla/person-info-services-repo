...
class DictionaryValueControllerTest {
    ...
    public void shouldUpdateDictionaryValueName() throws Exception {
        ...
        //when
        ResultActions resultActions = mockMvc.perform(MockMvcRequestBuilders.put("/api/dictionaryvalues")
                .contentType(MediaType.APPLICATION_JSON)
                .content(jsonForTest));
        //then
        resultActions
    ...
    public void shouldDeleteUnassignedDictionaryValues() throws Exception {
        ...
        dictionaryValueRepository.saveAndFlush(new DictionaryValue("employee")).getId();
        dictionaryValueRepository.saveAndFlush(new DictionaryValue("retiree")).getId();
