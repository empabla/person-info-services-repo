...
import pl.kurs.dictionaryservice.dto.*;
import pl.kurs.dictionaryservice.model.Dictionary;
import pl.kurs.dictionaryservice.service.DictionaryService;
...
public class DictionaryController {
    ...
    public ResponseEntity<DictionarySimpleDto> updateDictionaryName(@RequestBody @Valid UpdateDictionaryCommand command) {
        Dictionary updatedDictionary = dictionaryService.updateDictionaryName(command);
